...
const EXTRA: Item[] = [
  ...
  {
    id: 'evacuate',
    text: 'Отзыв существ работает и снимает предупреждение при закрытии',
    how: '«Бездонный зев» (4 существа) → «Отозвать существ» → счётчик существ = 0, риск слегка падает, кнопка исчезает. После этого «Закрыть портал» проходит без модалки.',
  },
  {
    id: 'summary',
  ...
  {
    id: 'random',
    text: 'Случайный портал генерируется валидным',
    how: 'Сценарии → «+ Случайный портал» несколько раз. Каждый раз новый портал (имя, мир, энергия/стабильность 0–100, существа 0–8), риск любой, запись в журнале.',
  },
  {
    id: 'tests',
    text: 'Автотесты проходят',
    how: 'npm test → 49 passed (домен: risk / actions / reducer / summary / text / seed).',
  },
  {
    id: 'build',
